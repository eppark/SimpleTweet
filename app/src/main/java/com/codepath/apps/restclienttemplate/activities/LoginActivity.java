...
public class LoginActivity extends OAuthLoginActionBarActivity<TwitterClient> {
	...
	public static final int LOCKOUT_TIME_MIN = 40;
	int loginAttempts;
	...
	public void onLoginFailure(Exception e) {
		...
		if (e.getMessage().equals(getString(R.string.twitter_invalid_credentials_error))) {
			...
			if (triesLeft > 0) {
				Toast.makeText(this, String.format("Invalid login! %d tries left.", (MAX_LOGIN_ATTEMPTS - loginAttempts)), Toast.LENGTH_LONG).show();
				...
				Toast.makeText(this, String.format("No more login tries left. Try again in %d minutes.", LOCKOUT_TIME_MIN), Toast.LENGTH_LONG).show();
			...
			Toast.makeText(this, "Couldn't login through Twitter. Try again later.", Toast.LENGTH_LONG).show();
		}
	}
	...
	public void loginToRest(View view) {
		...
		if (lockoutTime != null) {
			...
			if (minLeft < LOCKOUT_TIME_MIN) {
				Toast.makeText(this, String.format("Locked out. Try again in %d minutes.", (LOCKOUT_TIME_MIN - minLeft)), Toast.LENGTH_LONG).show();
				return;
			} else {
